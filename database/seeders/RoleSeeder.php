...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'users-requests'])->syncRoles([$role1,$role2]);
        Permission::create(['name' => 'accept'])->syncRoles([$role1,$role2]);
        Permission::create(['name' => 'deny'])->syncRoles([$role1,$role2]);
